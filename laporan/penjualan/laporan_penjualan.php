...
<body>
    ...
    <div style="margin:10px 0;">
        <form action="laporan_penjualan.php" id="fmFilter" method="post" novalidate>
            Tanggal Awal: 
    ...
    <div id="tampil_lap_penjualan">
        <table id="dg" title="Data Penjualan" class="easyui-datagrid" style="height:auto;"
                url="tampil_lap_penjualan.php?tgl_awal=<?php echo $_REQUEST['tgl_awal'] ?>&tgl_akhir=<?php echo $_REQUEST['tgl_akhir']; ?>";
                toolbar="#toolbar" rownumbers="true" fitColumns="true" singleSelect="true">
        		<thead>
        			<tr>
        		      <th field="id_penjualan" width="50">ID Transaksi</th>
                      <th field="tanggal_jual" width="50">Tanggal</th>
                      <th field="nama_pelanggan" width="50">Pelanggan</th>
        		      <th field="nama_barang" width="60">Nama Barang</th>
                      <th field="harga_jual" width="30">Harga Barang</th>
                      <th field="jumlah_jual" width="20">jumlah</th>
        ...
        <div id="toolbar" style="padding:2px;height:30px;">
            <div style="float:left;">
                <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-print" plain="true" 
                    ...
                    ','Laporan Penjualan','size=800,height=800,scrollbars=yes,resizeable=no')">Cetak</a>
            </div>
        </div>
    </div>
</body>
